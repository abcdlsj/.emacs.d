...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("all" "any" "archive" "chat-list" "contact" "custom" "define-telega-filter" "has-" "ids" "label" "last-message-by-me" "main" "name" "not" "opened" "permission" "pin" "restriction" "saved-messages" "telega-" "top" "tracking" "type" "user-status" "verified")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-sort" '("define-telega-sorter" "join-date" "member-count" "online-members" "order" "telega-" "title" "unread-count")))
