...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("all" "any" "archive" "chat-list" "contact" "custom" "define-telega-filter" "has-" "ids" "label" "last-message-by-me" "main" "name" "not" "online-status" "permission" "pin" "restriction" "saved-messages" "search" "telega-" "top" "tracking" "type" "unmuted" "unread" "verified")))
