...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#e7e5eb" :foreground "#655370" :box (:line-width 1 :color "#b3b9be") :slant normal :weight normal :height 100 :width normal :foundry "PfEd" :family "DejaVu Sans Mono-10")))))
