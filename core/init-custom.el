...
(custom-set-variables
 ...
 '(package-selected-packages
   '(neotree request exec-path-from-shell company company-prescient company-box auctex avy projectile highlight-indent-guides expand-region ivy ivy-rich all-the-icons-ivy-rich ivy-posframe ivy-xref ivy-yasnippet ivy-prescient ivy-fuz amx counsel-projectile smartparens popwin evil evil-leader evil-collection evil-nerd-commenter winum which-key markdown-mode lsp-mode lsp-ui ccls dap-mode rust-mode go-mode lsp-python-ms yasnippet yasnippet-snippets auto-yasnippet use-package dashboard page-break-lines all-the-icons posframe doom-modeline hide-mode-line modern-cpp-font-lock fontawesome nasm-mode clang-format racket-mode vterm wakatime-mode org-bullets org-download ox-hugo org-download persp-mode magit benchmark-init prescient color-theme-sanityinc-tomorrow spacemacs-theme modus-themes rime))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(corfu-border ((t (:background "light gray"))))
 '(corfu-default ((t (:background "light gray"))))
